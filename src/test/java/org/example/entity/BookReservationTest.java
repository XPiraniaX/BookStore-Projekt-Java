...
public class BookReservationTest {
    ...
    @Test
    public void testBookReservationCreation() {
        BookReservation reservation = new BookReservation();
        assertNotNull(reservation);
    }

    @Test
    public void testBookReservationBuilder() {
    ...
    @Test
    public void testBookReservationGettersAndSetters() {
        BookReservation reservation = new BookReservation();
    ...
    @Test
    public void testBookReservationEqualsAndHashCode() {
    ...
    @Test
    public void testBookReservationToString() {
        BookReservation reservation = BookReservation.builder()
                .id(1L)
                .user(user)
                .book(book)
    ...
    @Test
    public void testBookReservationAllArgsConstructor() {
